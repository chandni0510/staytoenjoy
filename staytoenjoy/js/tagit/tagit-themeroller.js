...
(function ($) { 'use strict';
    ...
    $.widget("ui.tagit", {
        ...
        _addTag: function (newTag) {
            ...
            tag.element = $('<li class="getvalue d-inline-block mr-2 mb-2 bg-theme border-r-20 mt-3 py-1 px-3 text-white position-relative hover-visible hover-dark  c-pointer"'
                ...
                + '<div class="tagit-label pr-3 float-left">' + newTag.label + '</div>' + '<a class="tagit-close ui-state-error-text">x</a></li>');
