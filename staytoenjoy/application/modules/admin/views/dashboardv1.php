...
<html class="no-js css-menubar" lang="en">
  <head>
    ...
    <link rel="apple-touch-icon" href="<?php echo base_url() ;?>/admin_desigin/images/apple-touch-icon.png">
    <link rel="shortcut icon" href="<?php echo base_url() ;?>/admin_desigin/images/favicon.ico">
    ...
    <link rel="stylesheet" href="<?php echo base_url() ;?>/admin_desigin/vendor/flag-icon-css/flag-icon.css">
        <link rel="stylesheet" href="<?php echo base_url() ;?>/admin_desigin/vendor/chartist/chartist.css">
        <link rel="stylesheet" href="<?php echo base_url() ;?>/admin_desigin/vendor/jvectormap/jquery-jvectormap.css">
        <link rel="stylesheet" href="<?php echo base_url() ;?>/admin_desigin/vendor/chartist-plugin-tooltip/chartist-plugin-tooltip.css">
        <link rel="stylesheet" href="<?php echo base_url() ;?>/admin_desigin/css/v1.css">
    
    
    <!-- Fonts -->
        <link rel="stylesheet" href="<?php echo base_url() ;?>/admin_desigin/fonts/weather-icons/weather-icons.css">
    ...
    <!--[if lt IE 9]>
    <script src="<?php echo base_url() ;?>/admin_desigin/vendor/html5shiv/html5shiv.min.js"></script>
    <![endif]-->
    
    <!--[if lt IE 10]>
    <script src="<?php echo base_url() ;?>/admin_desigin/vendor/media-match/media.match.min.js"></script>
    <script src="<?php echo base_url() ;?>/admin_desigin/vendor/respond/respond.min.js"></script>
    <![endif]-->
  ...
  <body class="animsition dashboard">
    ...
    <nav class="site-navbar navbar navbar-default navbar-fixed-top navbar-mega" role="navigation">
      ...
      <div class="navbar-header">
        ...
        <div class="navbar-brand navbar-brand-center site-gridmenu-toggle" data-toggle="gridmenu">
          <img class="navbar-brand-logo" src="<?php echo base_url() ;?>/admin_desigin/images/logo.png" title="Remark">
                      ...
                      <ul class="blocks-3">
                        <li>
                          <a class="thumbnail m-0" href="javascript:void(0)">
                            <img class="w-full" src="<?php echo base_url() ;?>/admin_desigin/photos/placeholder.png" alt="..." />
                          </a>
                        </li>
                        <li>
                          <a class="thumbnail m-0" href="javascript:void(0)">
            ...
            <li class="nav-item dropdown">
              <a class="nav-link navbar-avatar" data-toggle="dropdown" href="#" aria-expanded="false"
                ...
                <span class="avatar avatar-online">
                  <img src="<?php echo base_url() ;?>/admin_desigin/portraits/5.jpg" alt="...">
                  <i></i>
                </span>
              </a>
              <div class="dropdown-menu" role="menu">
                        ...
                        <div class="media">
                          <div class="pr-10">
                            <span class="avatar avatar-sm avatar-online">
                              <img src="<?php echo base_url() ;?>/admin_desigin/portraits/2.jpg" alt="..." />
                              <i></i>
                            </span>
                          </div>
                          <div class="media-body">
                        ...
                        <div class="media">
                          <div class="pr-10">
                            <span class="avatar avatar-sm avatar-off">
                              <img src="<?php echo base_url() ;?>/admin_desigin/portraits/3.jpg" alt="..." />
                              <i></i>
                            </span>
                          </div>
                          <div class="media-body">
                        ...
                        <div class="media">
                          <div class="pr-10">
                            <span class="avatar avatar-sm avatar-busy">
                              <img src="<?php echo base_url() ;?>/admin_desigin/portraits/4.jpg" alt="..." />
                              <i></i>
                            </span>
                          </div>
                          <div class="media-body">
    ...
    <script src="<?php echo base_url() ;?>/admin_desigin/vendor/slidepanel/jquery-slidePanel.js"></script>
        <script src="<?php echo base_url() ;?>/admin_desigin/vendor/skycons/skycons.js"></script>
        ...
        <script src="<?php echo base_url() ;?>/admin_desigin/vendor/aspieprogress/jquery-asPieProgress.min.js"></script>
        <script src="<?php echo base_url() ;?>/admin_desigin/vendor/jvectormap/jquery-jvectormap.min.js"></script>
        <script src="<?php echo base_url() ;?>/admin_desigin/vendor/jvectormap/maps/jquery-jvectormap-au-mill-en.js"></script>
        <script src="<?php echo base_url() ;?>/admin_desigin/vendor/matchheight/jquery.matchHeight-min.js"></script>
    ...
    <script src="<?php echo base_url() ;?>/admin_desigin/js/Plugin/switchery.js"></script>
        <script src="<?php echo base_url() ;?>/admin_desigin/js/Plugin/matchheight.js"></script>
        <script src="<?php echo base_url() ;?>/admin_desigin/js/Plugin/jvectormap.js"></script>
    
        <script src="<?php echo base_url() ;?>/admin_desigin/js/v1.js"></script>
  </body>
</html>
