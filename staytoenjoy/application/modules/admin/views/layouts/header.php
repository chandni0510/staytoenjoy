...
<link rel="stylesheet" href="<?php echo base_url() ;?>/admin_desigin/vendor/aspieprogress/asPieProgress.css">
<link rel="stylesheet" href="<?php echo base_url() ;?>/admin_desigin/vendor/chartist-plugin-tooltip/chartist-plugin-tooltip.css">
<link rel="stylesheet" href="<?php echo base_url() ;?>/admin_desigin/css/ecommerce.css">
<!--<link rel="stylesheet" href="<?php echo base_url() ;?>css/style.css"> -->
<!-- Fonts -->
<link rel="stylesheet" href="<?php echo base_url() ;?>/admin_desigin/fonts/font-awesome/font-awesome.css">
<link rel="stylesheet" href="<?php echo base_url() ;?>/admin_desigin/css/font-awesome.min.css"> 
...
<!-- datatable -->
<link rel="stylesheet" href="<?php echo base_url() ;?>/admin_desigin/vendor/datatables.net-bs4/dataTables.bootstrap4.css">
<link rel="stylesheet" href="<?php echo base_url() ;?>/admin_desigin/vendor/datatables.net-responsive-bs4/dataTables.responsive.bootstrap4.css">
<link rel="stylesheet" href="<?php echo base_url() ;?>/admin_desigin/vendor/datatables.net-buttons-bs4/dataTables.buttons.bootstrap4.css">

<!-- validation -->

<link rel="stylesheet" href="<?php echo base_url() ;?>admin_desigin/vendor/formvalidation/formValidation.css">
<link rel="stylesheet" href="<?php echo base_url() ;?>admin_desigin/css/validation.css">
 <link rel="stylesheet" href="<?php echo base_url('admin_desigin/vendor/dropify/dropify.css')?>">
<!-- Scripts -->
...
<body class="animsition ecommerce_dashboard">
    ...
    <nav class="site-navbar navbar navbar-default navbar-fixed-top navbar-mega" role="navigation">
        ...
        <div class="navbar-header">
            ...
            <div class="navbar-brand navbar-brand-center site-gridmenu-toggle logo_size" data-toggle="gridmenu">

                <img class="navbar-brand-logo logo_img_size" src="<?php echo base_url() ;?>/img/logo.svg" title="Remark">

                <span class="navbar-brand-text hidden-xs-down">StayToEnjoy</span>
            </div>
            ...
            <div class="collapse navbar-collapse navbar-collapse-toolbar" id="site-navbar-collapse">
                                        ...
                                        <ul class="blocks-2">
                                            ...
                                            <li class="mega-menu m-0">
                                                <ul class="list-icons">
                                                    ...
                                                    <li><i class="wb-chevron-right-mini" aria-hidden="true"></i>
                                                        <a href="javascript:void(0)">Overlay</a>
                                                    </li>
                                                    <li><i class="wb-chevron-right-mini" aria-hidden="true"></i>
                                                        <a href="javascript:void(0)">Tooltips</a>
                                                    </li>
                                                    <li><i class="wb-chevron-right-mini" aria-hidden="true"></i>
                                                        <a href="javascript:void(0)">Scrollable</a>
                                                    </li>
                                                    <li><i class="wb-chevron-right-mini" aria-hidden="true"></i>
                ...
                <ul class="nav navbar-toolbar navbar-right navbar-toolbar-right">
                  ...
                  <i></i>
                        ...
                        <div class="dropdown-menu" role="menu">
                            <a class="dropdown-item" href="<?php echo base_url('admin/admin_profile')?>" role="menuitem"><i class="icon wb-user" aria-hidden="true"></i> Profile</a>
