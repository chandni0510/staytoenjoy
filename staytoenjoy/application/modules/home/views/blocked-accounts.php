    ...
    <div class="container-fluid bg-theme position-fixed z-index-99">
      <div class="container">
        <ul class="pl-0 mb-0 font-14 py-2">
          ...
          <li class="d-inline-block"><a href="javascript:void(0)" class="text-white px-2 mx-2 pb-1 border-bottom-3-hover active">Blocked Accounts</a></li>
          ...
          <div class="w-63 offset-w-15 center-inbox-hide pr-2">
            <div class="p-3 pb-4 mb-4 profile-setting bg-white border border-r-10">
              ...
              <div class="contactForm">
                <h6 class="font-weight-bold text-dark my-3">Blocked Account</h6>
                <hr class="mt-4">
                <label class="font-14">You have blocked these account. You will not see their post in your timeline. blocked account cannot follow you or view your profile while loged into StayToEnjoy. learn more about <span class="text-theme-blue">blocking.</span></label>
                <hr class="my-4">
                <div class="row">
                  <label class="col font-14">All/<span class="text-theme-blue">Imported</span></label>
                  <div class="dropdown">
                    <label data-toggle="dropdown" class="col bg-transparent font-weight-bold text-secondary font-14 text-right c-pointer">Advanced Options
                      <i class="fa fa-caret-down pl-2"></i>
                        <div class="dropdown-menu font-14">
                          <a class="dropdown-item px-3" href="javascript:void(0)">Options</a>
                          <a class="dropdown-item px-3" href="javascript:void(0)">Options</a>
                        </div>
                    </label>
                  </div>
                ...
                <div class="form-group row">
                  <div class="col-sm-12">
                    ...
                    <h6 class="d-inline-block pl-2">Peter Pan <span class="text-secondary">@peter545</span></h6>
                    <div class="float-right">
                      <a href="javascript:void(0)" class="btn bg-transparent border text-dark border-r-20 border-dark px-4 font-14 mr-3">Blocked</a>
                      <div class="dropdown d-inline-block">
                        <i data-toggle="dropdown" class="fa fa-ellipsis-h c-pointer"></i>
                        <div class="dropdown-menu font-14">
                          <a class="dropdown-item px-3" href="javascript:void(0)">Edit</a>
                          <a class="dropdown-item px-3" href="javascript:void(0)">Delete</a>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="form-group row">
                  <div class="col-sm-12">
                    ...
                    <h6 class="d-inline-block pl-2">Peter Pan <span class="text-secondary">@peter545</span></h6>
                    <div class="float-right">
                      <a href="javascript:void(0)" class="btn bg-primary border-r-20 text-white px-4 font-14 mr-3">Unblock</a>
                      <div class="dropdown d-inline-block">
                        <i data-toggle="dropdown" class="fa fa-ellipsis-h c-pointer"></i>
                        <div class="dropdown-menu font-14">
                          <a class="dropdown-item px-3" href="javascript:void(0)">Edit</a>
                ...
                <div class="text-center">
                  <a href="javascript:void(0)" class="text-theme-blue c-pointer bg-transparent border-0">View more</a>
                </div>
              </div>
