            ...
            <table class="table table-hover dataTable table-striped w-full" data-plugin="dataTable">
              ...
              <?php if(!empty($users)){
              			...
              			<td > <div class="avatar avatar-online va-inhrt mr-2">
                            <img src="<?php echo base_url() ;?>/admin_desigin/portraits/1.jpg" alt="..."><i class="avatar avatar-busy"></i></div><?php echo  $user['comp_name'];?> </td>	
              			<td><?php echo $user['user_id']; ?></td>
						<td><?php echo  $user['comp_email']; ?></td>
              		    <td><?php echo  $user['comp_phone_no']; ?></td>
              		    <td><?php echo  $user['comp_gender']; ?></td>
              		    <td><?php echo  date('d/m/Y',strtotime($user['comp_founded'])); ?></td>
				...
				<div class="btn-group more-btn mousepointer" role="group">
                  ...
                  <div class="dropdown-menu more-drop animate" aria-labelledby="exampleAnimationDropdown1" role="menu">
                     <!-- <a class="dropdown-item text-decor-none" href="<?php echo base_url('home/savedlogin/').$user['user_id'];?>" target="blank" role="menuitem">
                      <i class="icon wb-eye"></i> Login to view</a> -->
                    <a class="dropdown-item text-decor-none" href="<?php echo base_url('admin/company_setting/').$user['user_id'];?>" role="menuitem">
                      <i class="icon wb-eye"></i> View</a>
					  <?php //echo base_url('admin/delete_user/').$user['user_id'];?>
                    <a class="dropdown-item text-decor-none" href="javascript:void(0)"  role="menuitem"><i class="icon wb-trash" onclick="deleteComp(this,'<?php echo $user['user_id']; ?>','<?php echo $user['company_id']; ?>')" ></i> Delete</a>
                  </div>
                </div>
              </td>
  						</tr>
