    ...
    <div class="container-fluid bg-theme position-fixed z-index-99">
      <div class="container">
        <ul class="pl-0 mb-0 font-14 py-2">
          ...
          <li class="d-inline-block"><a href="javascript:void(0)" class="text-white px-2 mx-2 pb-1 border-bottom-3-hover active">KYC Verifications</a></li>
            ...
            <div class="border p-3 pb-4 mb-4 profile-setting bg-white border-r-10">
              <div class="contactForm">
                <h6 class="font-weight-bold text-dark my-3">Your interests
                  <i class="fa fa-globe float-right pt-1"></i>
                </h6>
                <hr class="mt-4">
                <div class="form-group row">
                  <div class="col-sm-12 font-14">
                    <label>KYC stands for know your customer and entails the whole verification process of your users. The process is part of European anti-money laundering regulation. know as AML, which requires institutions such as MANGOPAY to make sure that money transacting through their system is clean. It will therefore be an integral part of your collaboration with us.</label>
                    <label>The whole verification process is automated thanks to our dedicated API endpoint. This feature is available for users worldwide and provides you with a global, compliant and trustful service.</label>
                    <label class="text-theme-blue">There are two levels of user verification, also called API levels: Light (default) and Regular.</label>
                    <label><span class="text-theme-blue">Light</span> (default) verification requires basic information provided during the user creation process.</label>
                    <label><span class="text-theme-blue">Regular</span> verification requires identity proof which allows users to handle unlimited funds freely.</label>
                  </div>
                </div>
                    ...
                    <div class="col-sm-12">
                      <ul class="list-s-none li-inline-b pl-0 mb-5 steps-line position-relative">
                        ...
                        <li class="w-25 text-center position-relative z-index-98">
                          ...
                          <p class="m-auto font-12 pt-1 pb-3">Upload your documents</p>
                        </li>
                        <li class="w-25 text-center position-relative z-index-98">
                          <a href="javascript:void(0)" class="bg-primary text-white border rounded-circle h-w-30-px d-flex align-items-center m-auto">
