    ...
    <div class="container-fluid bg-theme position-fixed z-index-99">
      <div class="container">
        <ul class="pl-0 mb-0 font-14 py-2">
          ...
          <li class="d-inline-block"><a href="javascript:void(0)" class="text-white px-2 mx-2 pb-1 border-bottom-3-hover active">Login History</a></li>
          ...
          <div class="w-63 offset-w-15 center-inbox-hide pr-2">
            <div class="p-3 pb-4 mb-4 profile-setting bg-white border border-r-10">
              <div class="contactForm">
                <h6 class="font-weight-bold text-dark my-3">Login History</h6>
                <hr class="mt-4">
                <div class="row">
                  <div class="col-sm-12 px-0">
                    <div class="table-responsive overflow-x-inherit">
                      <table class="table table-borderless font-14 table-hover">
                        ...
                        <tbody>
                          <tr>
                            <td>July 10</td>
                            <td>Signed in from Chorme (Windows)</td>
                            <td>CO,USA</td>
                            <td>About 5 hours ago</td>
                            <td class="float-right">Logged out
                              <a href="javascript:void(0)" class="fa fa-ellipsis-h pl-4 text-dark"></a>
                            </td>
                          </tr>
                          <tr>
                            <td>July 10</td>
