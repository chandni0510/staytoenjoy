    ...
    <div class="container-fluid bg-theme position-fixed z-index-99">
      <div class="container">
        <ul class="pl-0 mb-0 font-14 py-2">
          ...
          <li class="d-inline-block"><a href="javascript:void(0)" class="text-white px-2 mx-2 pb-1 border-bottom-3-hover active">Password</a></li>
          ...
          <div class="w-63 offset-w-15 center-inbox-hide pr-2">
            <div class="p-3 pb-4 mb-4 profile-setting bg-white border border-r-10">
              ...
              <div class="contactForm">
                <h6 class="font-weight-bold text-dark my-3">Password Settings</h6>
                <hr class="mt-4">
                <h6 class="text-dark mt-2 mb-4">Change your password</h6>
                <div class="form-group row">
                  <label class="col-sm-3 col-form-label font-14">Type old password</label>
                  <div class="col-sm-9 position-relative">
                    <input type="password" class="form-control font-14">
                    <img src="img/check-icon.svg" class="position-absolute check-icon pt-1">
                  </div>
                </div>
                <div class="form-group row">
                  <label class="col-sm-3 col-form-label font-14 pt-10px">Type new password</label>
                  <div class="col-sm-9 position-relative">
                    <input type="password" class="form-control font-14">
                    <img src="img/check-icon.svg" class="position-absolute check-icon pt-1">
                  </div>
                ...
                <div class="form-group row">
                  <label class="col-sm-3 col-form-label font-14 pt-10px">Confirm new password</label>
                  <div class="col-sm-9 position-relative">
                    <input type="password" class="form-control font-14">
                    <img src="img/check-icon.svg" class="position-absolute check-icon pt-1">
                  </div>
