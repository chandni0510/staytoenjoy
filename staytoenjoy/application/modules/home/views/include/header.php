...
<div class="embed-responsive embed-responsive-16by9">
  <iframe class="embed-responsive-item" src="" id="video"  allowscriptaccess="always"></iframe>
   ...
   <nav class="navbar navbar-expand-lg navbar-light fixed-top bg-white border-bottom z-index-99999" id="toggle-bg">
...
if(!empty($session)) {?>
      ...
      <ul class="navbar-nav desk-ul pt-2 pl-5 ml-2" style="margin-right: 25%;>
        ...
        <li class="nav-item position-relative pl-2 pr-3" id="request-click">
          <a class="nav-link position-relative menu-icon bg-secondary rounded-circle w-h-35px d-flex align-items-center justify-content-center" href="javascript:void(0)">
            <img src="<?php echo base_url()?>img/user.svg" class="w-h-22px"> <span class="notify-circle">5</span>
          </a>
        </li>
        ...
        <li class="nav-item pl-2 pr-3">
          <a class="nav-link position-relative menu-icon bg-secondary rounded-circle w-h-35px d-flex align-items-center justify-content-center" href="inbox.php">
            <img src="<?php echo base_url()?>img/msg.svg" class="w-h-22px"> <span class="notify-circle">3</span>
          </a>
        </li>
        <li class="nav-item pl-2 pr-3">
          <a class="nav-link position-relative menu-icon bg-secondary rounded-circle w-h-35px d-flex align-items-center justify-content-center" href="javascript:void(0)">
            <img src="<?php echo base_url()?>img/chat.svg" class="w-h-25px"> <span class="notify-circle">8</span>
          </a>
        </li>
        <li class="nav-item pl-2 pr-3">
          <a class="nav-link position-relative menu-icon bg-secondary rounded-circle w-h-35px d-flex align-items-center justify-content-center" href="calendar.php">
            <img src="<?php echo base_url()?>img/calendar.svg" class="w-h-22px"> <span class="notify-circle">9</span>
          </a>
        </li>
        <li class="nav-item pl-2 pr-3">
          <a class="nav-link position-relative menu-icon bg-secondary rounded-circle w-h-35px d-flex align-items-center justify-content-center" href="javascript:void(0)">
            <img src="<?php echo base_url()?>img/cart.svg" class="w-h-22px"> <span class="notify-circle">9</span>
          </a>
        </li>
        <li class="nav-item pl-2 pr-3" id="notif-click">
          <a class="nav-link position-relative menu-icon bg-secondary rounded-circle w-h-35px d-flex align-items-center justify-content-center" href="javascript:void(0)">
            <img src="<?php echo base_url()?>img/notification-tab.svg" class="w-h-22px"><span class="notify-circle">8</span>
          </a>
        </li>
        <li class="nav-item dropdown hide-caret">
          ...
          <a class="nav-link position-relative menu-icon d-flex align-items-center pt-4px dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown">
              ...
              <?php if(isset($users) && !empty($users->user_img)){
                       $user_img =   base_url().'/uplaods/profile/'.$users->user_img;
                        ...
                        $user_img = base_url().'/img/profile-pic.svg';
                     }
                  ?>
            <img src="<?php echo $user_img;?>" style="width:25px; height:26px; padding-top:2px;border-radius: 50%" class="profileImage">
      ...
      <ul class="navbar-nav align-self-end mr-auto mob-ul">
        ...
        <li class="nav-item pl-1 pr-2 dropdown">
          <a class="nav-link position-relative menu-icon dropdown-toggle" href="javascript:void(0)" id="navbarDropdown" role="button" data-toggle="dropdown"> 
            <img src="<?php echo base_url('img/profile.png');?>" style="width:28px; height:28px"><strong> Profile </strong>
          </a>
