...
<html class="no-js css-menubar" lang="en">
  ...
  <body class="animsition ecommerce_dashboard">
              ...
              <div class="card-block bg-white table-responsive">
                <table class="table">
                  ...
                  <tbody>
                    <tr>
                      <td>
                        <img src="<?php echo base_url() ;?>/admin_desigin/images/products/imac.png"
                          alt="iMac" />
                      </td>
                      <td>iMac</td>
                      <td>Russell</td>
                    ...
                    <tr>
                      <td>
                        <img src="<?php echo base_url() ;?>/admin_desigin/images/products/iphone.png"
                          alt="iPhone" />
                      </td>
                      <td>iPhone</td>
                      <td>Carol</td>
                    ...
                    <tr>
                      <td>
                        <img src="<?php echo base_url() ;?>/admin_desigin/images/products/applewatch.png"
                          alt="apple_watch" />
                      </td>
                      <td>apple Watch</td>
                      <td>Austin Pena</td>
                    ...
                    <tr>
                      <td>
                        <img src="<?php echo base_url() ;?>/admin_desigin/images/products/macmouse.png"
                          alt="mac_mouse" />
                      </td>
                      <td>mac Mouse</td>
                      <td>Randy</td>
    ...
    <script>Config.set('assets', '<?php echo base_url() ;?>admin_desigin/');</script>
